...
int main(int, char**)
{
	...
	createTrackbar("阈值：","threshold", nullptr, 255, segment_track);
	createTrackbar("min: ","contours", nullptr, 300000, contours_min_track);
	createTrackbar("max: ","contours", nullptr, 300000, contours_max_track);
...
void segment_track(int,void *)
{
    iLowH =  getTrackbarPos("阈值：","threshold");
    imgThresholded = segment_img(frame);
    imshow("threshold",imgThresholded);
    vector<vector<Point> > contours;
    vector<int> squar_index;
...
void contours_min_track(int,void *)
{
    rect_min = getTrackbarPos("min: ","contours");
    vector<vector<Point> > contours;
    vector<int> squar_index;
    contours_filter(imgThresholded, contours, squar_index);
    point_img = pick_point(imgThresholded,contours, squar_index);
...
void contours_max_track(int,void *)
{
    rect_max = getTrackbarPos("max: ","contours");
    vector<vector<Point> > contours;
    vector<int> squar_index;
    contours_filter(imgThresholded, contours, squar_index);
    point_img = pick_point(imgThresholded,contours, squar_index);
